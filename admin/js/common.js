// termekcsoportok szukitese #  #  #

function get_termekcsoport()
{
	//
	var focsop_inp = $('tk_focsop');
	//alert(0);
	focsop_inp.addEvent('change', function()
	{
		// input mezo ertek
		var i = focsop_inp.getValue();
			//alert(i);
			// telepules ajaxbul		
			new Ajax('remote/ajax_csoportok.php',
			{
				method: 'post',
				data: 'tk_focsop=' + i,
