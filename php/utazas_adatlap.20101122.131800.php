			...
			<div class="box_data"><div class="bgr_top"><div class="bgr_bot clearfix">
				<div class="data_sheet clearfix">
					<div class="cont clearfix">
						...
						<div class="price"><?php echo $adatlap ['utazas_ar']; ?> Ft-tól</div>
						<div class="clear"></div>
						<?php if (file_exists("uploads/utazasok/{$adatlap ['id']}/s.jpg")) { ?>
						<div class="pic"><a href="<?php echo "uploads/utazasok/{$adatlap ['id']}/b.jpg"; ?>" rel="clearbox[gallery=My Gallery]"><img src="<?php echo "uploads/utazasok/{$adatlap ['id']}/s.jpg"; ?>" alt="" /></a><br />
						<?php 
						if (count($tmp_galeria) > 0) { 
							echo '<a href="' . $tmp_galeria [0] ['path'] . 'b.jpg" rel="clearbox[gallery=My Gallery]" title="' . $tmp_galeria [0] ['name'] . '">További képek</a>';
						}
						?>
						</div>
						<?php 
						if (count($tmp_galeria) > 0) { 
							...
							foreach ($tmp_galeria as $row_gal) {
								echo '<a href="' . $row_gal ['path'] . 'b.jpg" rel="clearbox[gallery=My Gallery]" title="' . $row_gal ['name'] . '"><img src="' . $row_gal ['path'] . 'b.jpg"' . ' /></a>';
							}
							echo '</div>';
						?>
