...
?>		
			<div class="box_yellow"><div class="bgr_top"><div class="bgr_bot clearfix">
				...
				<div class="box_border">
					<div class="cont">
						<div class="price"><a href="<?php echo $row ['webcim']; ?>"><?php echo $row ['utazas_ar']; ?> Ft-tól</a></div>
						<div class="clear"></div>
...
?>
			<div class="box_default"><div class="bgr_top"><div class="bgr_bot clearfix">
			<div class="ful_utazasok">Utazás</div>
				...
				<div class="box_border">
					<div class="cont">
						<div class="price"><a href="<?php echo $row ['webcim']; ?>" title="<?php echo $tmp_orszag [$row ['utazas_orszag']]; ?> - <?php echo $tmp_varos [$row ['utazas_varos']]; ?> <?php echo $row ['utazas_hotel']; ?>"><?php echo $row ['utazas_ar']; ?> Ft-tól</a></div>
						<div class="clear"></div>
						<div class="title clearfix">
